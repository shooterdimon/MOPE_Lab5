...
def after_main_2(x1_min, x1_max, x2_min, x2_max, x3_min, x3_max,m=3 , N=15, p=0.95):
    ...
    if not result_:
        ...
        dispersion15 = sum([(_ - y_average_list[14]) ** 2 for _ in matrix_y[14]]) / m
        ...
        def x(i):
            all_raw = list(map(lambda x: [1] + x,
                               [row + [row[0] * row[1],
                                ...
                                row[1] * row[2],
                                row[0] * row[1] * row[2]] +
                                list(map(lambda x: round(x ** 2, 5), row)) for row in matrix_x_natural]))
        ...
        for _ in range(len(matrix_x_natural)):
            ch2_list.append(
                beta_list[0] + beta_list[1] * matrix_x_natural[_][1] + \
                beta_list[2] * matrix_x_natural[_][2] + \
                beta_list[3] * matrix_x_natural[_][3] + \
                beta_list[4] * matrix_x_natural[_][4] + \
                beta_list[5] * matrix_x_natural[_][5] + \
                beta_list[6] * matrix_x_natural[_][6] + \
                beta_list[7] * matrix_x_natural[_][7] + \
                beta_list[8] * matrix_x_natural[_][8] + \
                beta_list[9] * matrix_x_natural[_][9] + \
                beta_list[10] * matrix_x_natural[_][10])
